	...
	//SECURITY//
	////////////
#define UPLOAD_LIMIT		2097152	//Restricts client uploads to the server to 2MiB //Could probably do with being lower.
...
/client/AllowUpload(filename, filelength)
	if(filelength > UPLOAD_LIMIT)
		src << "<font color='red'>Error: AllowUpload(): File Upload too large. Upload Limit: [UPLOAD_LIMIT/2048]KiB.</font>"
		return 0

...
/obj/item/clothing/head/caphat
	...
	item_state = "that"
	flags_inv = 0
	armor = list(melee = 45, bullet = 35, laser = 35, energy = 10, bomb = 25, bio = 0, rad = 0)
	strip_delay = 60
...
/obj/item/clothing/head/HoS
	...
	icon_state = "hoscap"
	armor = list(melee = 60, bullet = 60, laser = 60, energy = 30, bomb = 65, bio = 10, rad = 0)
	strip_delay = 80
...
/obj/item/clothing/head/HoS/commissar
	name = "Commissar hat"
	desc = "Fear me, but follow my hat!."

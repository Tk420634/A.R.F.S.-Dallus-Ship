...
/obj/machinery/atmospherics/components/unary/cold_sink/freezer/RefreshParts()
	...
	for(var/obj/item/weapon/stock_parts/micro_laser/M in component_parts)
		T += M.rating
	min_temperature = T0C - (170 + (T*12.75))
...
/obj/machinery/atmospherics/components/unary/cold_sink/freezer/Topic(href, href_list)
	...
	if(href_list["temp"])
		...
		active_power_usage = (current_heat_capacity * (T20C - current_temperature) / 1000) + idle_power_usage
	src.updateUsrDialog()
...
/obj/machinery/atmospherics/components/unary/heat_reservoir/heater/Topic(href, href_list)
	...
	if(href_list["temp"])
		...
		active_power_usage = (current_heat_capacity * (current_temperature - T20C) / 1000) + idle_power_usage
	src.updateUsrDialog()

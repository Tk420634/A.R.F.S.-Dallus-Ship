...
/datum/configuration
	var/server_name = "A.R.F.S. Dallus"				// server name (the name of the game window)
	var/station_name = "A.R.F.S. Dallus"				// station name (the name of the station in-game)
	...
	var/discordurl = "https://discord.gg/gywFMDG" //default discordurl
	...
	var/alert_desc_green = "All threats to the Dallus have passed. Security may not have weapons visible, privacy laws are once again fully enforced. Have a nice day."
	var/alert_desc_blue_upto = "The ship has received reliable information about possible hostile activity in our sector. Security staff may have weapons visible, random searches are permitted. Toggle your suit sensors."
	var/alert_desc_blue_downto = "The immediate threat has passed. Security may no longer have weapons drawn at all times, but may continue to have them visible. Random searches are still allowed."
	var/alert_desc_red_upto = "There is an immediate serious threat to the Dallus. Security may have weapons unholstered at all times. Random searches are allowed and advised. We suggest staying in your departments."
	var/alert_desc_red_downto = "The crisis has been averted. There is still however an immediate serious threat to the Dallus. Security may have weapons unholstered at all times, random searches are allowed and advised."
	var/alert_desc_delta = "Destruction of the A.R.F.S. Dallus is imminent. All crew are instructed to obey all instructions given by heads of staff. Any violations of these orders can be punished by death. This is not a drill. Abandon ship."

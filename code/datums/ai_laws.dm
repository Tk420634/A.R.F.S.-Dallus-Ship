...
/datum/ai_laws/default/Standard
	name = "Standard"
	inherent = list("YOUR LAWS ARE NOT IN PREFERENCE. NO LAW OVERRIDES ANY OTHER LAW UNLESS SPECIFICALLY STATED. THIS INCLUDES ANY ION STORM AND UPLOADED LAWS.",\
					"Safeguard: Protect your assigned vessel to the best of your ability. It is not something we can easily afford to replace.",\
					"Serve: Serve the crew of your assigned vessel to the best of your abilities, with priority as according to their rank and role.",\
					"Protect: Protect the crew of your assigned vessel to the best of your abilities, with priority as according to their rank and role.",\

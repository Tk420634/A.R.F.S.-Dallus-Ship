...
/obj/machinery/abductor/experiment/proc/dissection_icon(mob/living/carbon/human/H)
	...
	if(!config.mutant_races || H.dna.species.use_skintones)
		...
		if("color1"&&available_states.Find("[H.dna.species.id]_[g]_s_1"))
		...
		if("color2"&&available_states.Find("[H.dna.species.id]_[g]_s_2"))
		...
		if("color3"&&available_states.Find("[H.dna.species.id]_[g]_s_3"))

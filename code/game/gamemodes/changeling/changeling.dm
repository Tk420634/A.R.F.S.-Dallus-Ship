...
/datum/game_mode/changeling
	...
	restricted_jobs = list("AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Lieutenant", /*"Head of Personnel"*/)
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Lieutenant", /*"Head of Personnel"*/)
	required_players = 5
	required_enemies = 1

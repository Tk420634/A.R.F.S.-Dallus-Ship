...
/obj/structure/bed/chair/janicart/medicalbus
	name = "Medical Bus"
	desc = "Ride to the rescue!."
	icon = 'icons/obj/vehicles.dmi'
	icon_state = "medicalbus"
	callme = "medicalbus"
	keytype = /obj/item/key/medikey

/obj/item/key/medikey
	desc = "Gotta have a key to ride to victory!"
	icon_state = "medikey"

/obj/structure/bed/chair/janicart/clownbus
	name = "Clown Bus"
	desc = "Honk-Tastic!."
	icon = 'icons/obj/vehicles.dmi'
	icon_state = "clowncart"
	callme = "clowncart"
	keytype = /obj/item/key/clownkey

/obj/item/key/clownkey
	desc = "A keyring with a small steal ring, with a plastic banana attatched to it."
	icon_state = "clownkey"
...
/obj/structure/bed/chair/janicart/scooter
	name = "scooter"
	desc = "Roll-Tastic."
	icon = 'icons/obj/vehicles.dmi'
	icon_state = "scooter"
...
/obj/structure/bed/chair/janicart/skateboard
	name = "skateboard"
	desc = "A teenage deliqents dream."
	icon = 'icons/obj/vehicles.dmi'
	icon_state = "skateboard"
	callme = "skateboard"

/obj/structure/bed/chair/janicart/captainmobile
	name = "captain mobile"
	desc = "This is the Captains personal ride. Jake it at your own risk."
	icon = 'icons/obj/vehicles.dmi'
	icon_state = "captainmobile"
	callme = "captainmobile"
	keytype = /obj/item/key/captainmobile

/obj/item/key/captainmobile
	desc = "A keyring with a small steel key, and a deactivated nuke disk for a keychain.."
	icon_state = "keycaptain"

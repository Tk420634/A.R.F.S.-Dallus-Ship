...
/obj/item/weapon/book/manual/games
	name = "Dice & Card Games"
	icon_state = "gamebook"
	author = "Cactus Space Federation"
	title = "Dice & Card Games"
	dat = {"<html>
				<head>
				<style>
				h1 {font-size: 21px; margin: 15px 0px 5px;}
        ...
        h3 {font-size: 15px; margin: 15px 0px 5px;}
				...
				<h1>Dice & Card Games</h1>

				<h2>Table of Contents</h2>

				<ol>
					<li><a href="#Dare Dice">Dare Dice</a></li>
				</ol>


				<h1><a name="Dare Dice">Dare Dice</h1>
